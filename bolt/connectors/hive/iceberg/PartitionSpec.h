...
/// contains only the necessary fields for Bolt. Partition keys are computed
...
/// partition spec that is passed to Bolt.
///
/// IMPORTANT: Iceberg spec uses field IDs to identify source columns, but
/// Bolt RowType only supports matching fields by name. Therefore, Bolt uses
...
struct IcebergPartitionSpec {
  ...
  /// partition.
  /// @throws BoltUserError if validation fails.
